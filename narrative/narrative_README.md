...
- **Hlas vyprávění — KRITICKÉ:** Hráč je příjemce zprávy (mnich v klášteře), ne autor dopisu. Texty NIKDY nepsat v 1. osobě množného čísla ("my", "naše", "nám") — i kdyby pramen (dopis, deník) byl takto napsaný. Vždy začít reportážním rámcem: "Z [místo] přišla zpráva, že...", "[Role/jméno] píše, že...", "Ze zápisků [zdroj]: ...". Obsah pak ve 3. osobě nebo nepřímé řeči. `source_label` se hráči NEZOBRAZUJE (jen interní metadata) — rámec musí být vždy součástí `text_cs`/`text_en` samotného.
  - Špatně: "Naše loď byla potopena, očekáváme ztráty."
  - Správně: "Z Janova přišla zpráva: Loď Datiniho domu byla potopena. Očekávají se značné ztráty."
...
| `stare_letopisy` | Staré letopisy české, Praha | 6–12 | Praha — král Jiří, místní politika; rozlišeno dle typu (kurýr 5–6 dní, posel 7–9, kupecká pošta 10–14) |
